    ...
    <Paper className={classes.jobTileOuter} elevation={5}>
      <Grid container>
        <Grid container item xs={7} spacing={1} direction="column">
          ...
          <Grid item>Durée : {job.duration !== 0 ? `${job.duration} mois` : `Flexible`}</Grid>
          <Grid item>Date de publication: {postedOn.toLocaleDateString()}</Grid>
          <Grid item>Nombre de candidatures: {job.maxApplicants}</Grid>
          <Grid item>
            Nombre de postes disponibles : {job.maxPositions - job.acceptedCandidates}
          </Grid>
          <Grid item>
      ...
      <Modal open={openUpdate} onClose={handleCloseUpdate} className={classes.popupDialog}>
        ...
        >
          ...
          <Grid container direction="column" spacing={3} style={{ margin: '10px' }}>
            ...
            <Grid item>
              <TextField
                label="Nombres maximum de candidats"
                type="number"
                variant="outlined"
