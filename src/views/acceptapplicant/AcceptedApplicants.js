              ...
              >
                ...
                <Grid item>
                  <label htmlFor="jobTitle">
                    <Typography>Titre de l'offre</Typography>
                  </label>
                </Grid>
                <Grid item>
                  <IconButton
              ...
              >
                ...
                <Grid item>
                  <label htmlFor="dateOfJoining">
                    <Typography>Date d'adhésion</Typography>
                  </label>
                </Grid>
                <Grid item>
                  <IconButton
      ...
      <Grid container>
        ...
        <Grid container item xs={7} spacing={1} direction="column">
          ...
          <Grid item>
            <Rating
              value={
                application.jobApplicant.rating !== -1 ? application.jobApplicant.rating : null
              }
              readOnly
            />
          </Grid>
          <Grid item>Titre de l'offre: {application.job.title}</Grid>
          <Grid item>Rôle: {application.job.jobType}</Grid>
          <Grid item>Appliqué sur: {appliedOn.toLocaleDateString()}</Grid>
          <Grid item>SOP: {application.sop !== '' ? application.sop : 'Non soumis'}</Grid>
          <Grid item>
...
const AcceptedApplicants = (props) => {
  ...
  return (
    <>
      ...
      >
        <Grid item>
          <Typography variant="h2">Employées</Typography>
        </Grid>
        <Grid item>
